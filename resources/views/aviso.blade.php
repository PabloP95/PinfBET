...
<div class="container p-3 text-white text-justify">
    ...
    <p>
    <ul>
        <li><b>Titular:</b> Equipo 5.</li>
        <li><b>Registro mercantil:</b>  Inscrita en el Registro Mercantil de Cádiz, Tomo 8081, Libro 0, Folio 69, Seccion 8 Hoja M-130462 Inscripción 1ª</li>
        <li><b>NIF:</b>  A05050505</li>
        <li><b>Domicilio:</b> C/ Cinco, Nº 5 CP 11510 Puerto Real, Cádiz.</li>
        <li><b>Correo electrónico:</b> info@equipo5.com</li>
        <li><b>Sitio Web:</b> www.pinfbet.com</li>
    </ul>
</p>
...
<p>
<ul>
    <li>Primera convocatoria del curso deberán ser subidas las actas antes de terminar el mes de Febrero.
        <ul>
            <li>Se incluye la especial de Diciembre en este apartado.</li>
        </ul>
    </li>
    <li>Segunda convocatoria del curso deberán ser subidas las actas antes de finalizar el mes de Julio.</li>
    <li>Tercera convocatoria del curso deberán ser subidas antes de finalizar el mes de Octubre.</li>
</ul>
<h4>Comentarios o mensajes</h4>
<p>El Titular se reserva el derecho de retirar todos aquellos comentarios o mensajes que vulneren la legislación vigente, lesivos de los derechos o intereses de terceros, o que, a su juicio, no resulten adecuados para su publicación o comunicación con otros usuarios.</p>
...
<p>Todos los usuarios del sitio se comprometen a no difundir, publicar o transmitir por cualquier medio o forma la información contenida en el sitio web de otros usuarios, concretamente sus calificaciones finales y/o datos personales. Siendo por lo tanto responsable de la publicación de la información de cualquier forma o medio el usuario que lo realice, eximiendo por lo tanto la responsabilidad del sitio web.</p>
<h4>Bloqueo de la cuenta de usuario</h4>
<p>A continuación se detallan todos los motivos por lo que puede ser bloqueada una cuenta de usuario en el sitio web:</p>
<p>
<ul>
...
<p>Siempre que no haya una norma que obligue a otra cosa, para cuantas cuestiones se susciten sobre la interpretación, aplicación y cumplimiento de este Aviso Legal, así como de las reclamaciones que puedan derivarse de su uso, las partes acuerdan someterse a los Jueces y Tribunales de la provincia de Cádiz, con renuncia expresa de cualquier otra jurisdicción que pudiera corresponderles.</p>
<h4>Contacto</h4>
<p>En caso de que usted tenga cualquier duda acerca de estas Condiciones legales o quiera realizar cualquier comentario sobre este sitio Web, puede enviar un mensaje de correo electrónico a la dirección info@pinfbet.com .</p>
</div>
@endsection
